...
static const yytype_int8 yyrline[] =
{
      ...
      40,    41,    42,    43,    44,    45,    49,    58,    62,    66,
      71,    75,    82,    86,    92,    95,    96
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STDERR", "$accept", "cmd_line", "redirection", "nonBuilt", "err", YY_NULLPTR
};
#endif
...
{
      21,     0,    30,   -40,    -2,    12,    27,    13,    16,    22,
      32,    -3,   -40,    35,   -40,    38,   -40,     1,    39,   -40,
       3,    40,    41,   -40,   -40,   -40,    44,    15,    -1,    43,
     -40,    45,    46,    49,    48,    50,    51,   -40,   -40,    23,
      31,    53,   -40,    54,   -40,   -40,   -40,    55,   -40,   -40,
      56,    28,   -40,   -40,    31,   -40,   -40,   -40,    31,    59,
     -40,   -40,    31,   -40
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,    24,     2,     0,    10,     0,    12,     0,     0,     4,
       0,     0,     0,     1,    15,    23,     0,     0,     0,     0,
       9,     0,     0,     0,     0,     0,     0,     7,     8,    24,
      24,     0,    25,     0,    16,    11,    13,     0,     3,     5,
       0,     0,    17,    18,    24,    26,    14,     6,    24,     0,
      19,    20,    24,    21
};
...
{
      52,    53,    25,    15,    42,    16,    32,    12,    35,    26,
      27,    17,    28,    43,    33,    60,    36,    18,    21,    61,
      40,    22,    23,    63,     1,     2,     3,     4,    41,     5,
       6,     7,     8,    58,    19,    13,    51,    14,    28,    24,
      20,    59,    30,    31,    34,     0,    28,    37,    38,    39,
      44,     0,    45,    46,    47,    48,    50,    49,    54,    55,
       0,     0,    56,    57,    62
};

static const yytype_int8 yycheck[] =
{
      39,    40,     5,     5,     5,     7,     5,     7,     5,    12,
      13,    13,    15,    14,    13,    54,    13,     5,     5,    58,
       5,     5,     0,    62,     3,     4,     5,     6,    13,     8,
       9,    10,    11,     5,     7,     5,    13,     7,    15,     7,
      13,    13,     7,     5,     5,    -1,    15,     7,     7,     5,
       7,    -1,     7,     7,     5,     7,     5,     7,     5,     5,
      -1,    -1,     7,     7,     5
};
...
static const yytype_int8 yystos[] =
{
      ...
      18,    19,     7,     5,     7,     5,     7,    13,     5,     7,
      13,     5,     5,     0,     7,     5,    12,    13,    15,    20,
       7,     5,     5,    13,     5,     5,    13,     7,     7,     5,
       5,    13,     5,    14,     7,     7,     7,     5,     7,     7,
       5,    13,    20,    20,     5,     5,     7,     7,     5,    13,
      20,    20,     5,    20
};
...
#line 1378 "PARSER.tab.c"
  ...
  case 5:
#line 35 "PARSER.y"
                                                {printEnvFile((yyvsp[-1].string), 0); return 1;}
#line 1384 "PARSER.tab.c"
    break;

  case 6:
#line 36 "PARSER.y"
                                        {printEnvFile((yyvsp[-1].string), 1); return 1;}
...
#line 1426 "PARSER.tab.c"
  ...
  case 13:
#line 43 "PARSER.y"
                                                {printAliasFile((yyvsp[-1].string),0); return 1;}
#line 1432 "PARSER.tab.c"
    break;

  case 14:
#line 44 "PARSER.y"
                                                {printAliasFile((yyvsp[-1].string),1); return 1;}
...
#line 1459 "PARSER.tab.c"
  ...
  case 17:
#line 58 "PARSER.y"
                                                                        {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[-1].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],"");
												cmdTable.append[cmdTableIndex] = false;
												}
...
#line 62 "PARSER.y"
                                                                        {strcpy(cmdTable.inputFile[cmdTableIndex],"");
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[-1].string));
												cmdTable.append[cmdTableIndex] = false;
												}
...
#line 1487 "PARSER.tab.c"
  ...
  case 20:
#line 71 "PARSER.y"
                                                                {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[-3].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[-1].string));
												cmdTable.append[cmdTableIndex] = false;
												}
#line 1496 "PARSER.tab.c"
  ...
  case 21:
#line 75 "PARSER.y"
                                                                {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[-4].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[-1].string));
												cmdTable.append[cmdTableIndex] = true;
												}
...
#line 82 "PARSER.y"
                                                                                        {
												strcpy(cmdTable.cmd[cmdTableIndex],(yyvsp[0].string));
...
#line 86 "PARSER.y"
                                                                                {
												strcpy(cmdTable.arguments[cmdTableIndex].argu[argumentCounter], (yyvsp[0].string));
												argumentCounter++;
												}
...
#line 1531 "PARSER.tab.c"
  ...
  case 25:
#line 95 "PARSER.y"
                                                                                        {strcpy(cmdTable.errRedirectFile[cmdTableIndex], (yyvsp[0].string));}

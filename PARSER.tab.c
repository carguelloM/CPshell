...
{
       0,     0,     3,     6,    11,    14,    18,    22,    26,    29,
      34,    37,    40,    44,    49,    54,    60,    67,    75,    77,
      80,    81,    84
};
...
{
      17,     0,    -1,     3,     7,    -1,     8,     5,     5,     7,
      -1,     9,     7,    -1,    10,     5,     7,    -1,    11,     5,
       7,    -1,     4,     5,     7,    -1,     4,     7,    -1,     6,
       5,     5,     7,    -1,     6,     7,    -1,    18,     7,    -1,
      19,    20,     7,    -1,    19,    12,     5,    20,    -1,    19,
      13,     5,    20,    -1,    19,    13,    13,     5,    20,    -1,
      19,    12,     5,    13,     5,    20,    -1,    19,    12,     5,
      13,    13,     5,    20,    -1,     5,    -1,    19,     5,    -1,
      -1,    15,     5,    -1,    15,    14,     5,    -1
};
...
static const char *const yytname[] =
{
  ...
  "SETENV", "PRINTENV", "UNSETENV", "UNALIAS", "IOIN", "IOUT", "BACKGRND",
  "STDERR", "$accept", "cmd_line", "redirection", "nonBuilt", "err", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    20,     2,     0,     8,     0,    10,     0,     4,     0,
       0,     1,    11,    19,     0,     0,     0,     0,     7,     0,
       0,     5,     6,    20,    20,     0,    21,     0,    12,     9,
       3,     0,    13,    14,    20,    22,    20,     0,    15,    16,
      20,    17
};
...
{
      15,    -4,    -1,   -34,    22,    23,    24,    28,    29,    35,
      30,    -3,   -34,    31,   -34,    34,   -34,    36,   -34,    33,
      37,   -34,   -34,   -34,    38,     2,     0,    39,   -34,    40,
      41,   -34,   -34,    17,     7,    44,   -34,    45,   -34,   -34,
     -34,     3,   -34,   -34,     7,   -34,     7,    46,   -34,   -34,
       7,   -34
};
...
{
      42,    43,    23,    12,    13,    36,    14,    34,    46,    24,
      25,    48,    26,    49,    37,    35,    47,    51,     1,     2,
       3,     4,    26,     5,     6,     7,     8,    15,    17,    16,
      41,    18,    26,    19,    20,    21,     0,    22,    28,    29,
      31,    30,     0,    33,    32,     0,    38,    39,    40,    44,
      45,    50
};

static const yytype_int8 yycheck[] =
{
      33,    34,     5,     7,     5,     5,     7,     5,     5,    12,
      13,    44,    15,    46,    14,    13,    13,    50,     3,     4,
       5,     6,    15,     8,     9,    10,    11,     5,     5,     7,
      13,     7,    15,     5,     5,     0,    -1,     7,     7,     5,
       7,     5,    -1,     5,     7,    -1,     7,     7,     7,     5,
       5,     5
};
...
static const yytype_uint8 yystos[] =
{
      ...
      18,    19,     7,     5,     7,     5,     7,     5,     7,     5,
       5,     0,     7,     5,    12,    13,    15,    20,     7,     5,
       5,     7,     7,     5,     5,    13,     5,    14,     7,     7,
       7,    13,    20,    20,     5,     5,     5,    13,    20,    20,
       5,    20
};
...
#line 38 "PARSER.y"
  ...
  case 11:
#line 39 "PARSER.y"
    {cmdTable.arguments[cmdTableIndex].argumentNum = argumentCounter;
									argumentCounter = 0;
									cmdTableIndex++;
									return 1;;}
    break;
...
#line 43 "PARSER.y"
  ...
  case 13:
#line 52 "PARSER.y"
    {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[(3) - (4)].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],"");
												cmdTable.append[cmdTableIndex] = false;
												;}
    break;
...
#line 56 "PARSER.y"
    {strcpy(cmdTable.inputFile[cmdTableIndex],"");
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[(3) - (4)].string));
												cmdTable.append[cmdTableIndex] = false;
												;}
    break;
...
#line 60 "PARSER.y"
    {
												strcpy(cmdTable.inputFile[cmdTableIndex],"");
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[(4) - (5)].string));
  ...
  case 16:
#line 65 "PARSER.y"
    {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[(3) - (6)].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[(5) - (6)].string));
												cmdTable.append[cmdTableIndex] = false;
												;}
    break;
  ...
  case 17:
#line 69 "PARSER.y"
    {strcpy(cmdTable.inputFile[cmdTableIndex],(yyvsp[(3) - (7)].string));
												strcpy(cmdTable.outputFile[cmdTableIndex],(yyvsp[(6) - (7)].string));
												cmdTable.append[cmdTableIndex] = true;
												;}
    break;
...
#line 80 "PARSER.y"
    {
												strcpy(cmdTable.arguments[cmdTableIndex].argu[argumentCounter], (yyvsp[(2) - (2)].string));
												argumentCounter++;
												;}
    break;
...
#line 86 "PARSER.y"
  ...
  case 21:
#line 89 "PARSER.y"
    {strcpy(cmdTable.errRedirectFile[cmdTableIndex], (yyvsp[(2) - (2)].string));;}
    break;

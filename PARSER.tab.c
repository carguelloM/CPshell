...
static const char *const yytname[] =
{
  ...
  "SETENV", "PRINTENV", "UNSETENV", "UNALIAS", "$accept", "cmd_line", 0
};
#endif
...
#line 31 "PARSER.y"
  ...
  case 6:
#line 32 "PARSER.y"
    {unsetAlias((yyvsp[(2) - (3)].string)); disableAliases = false; return 1;;}
    break;
...
#line 34 "PARSER.y"
  ...
  case 9:
#line 35 "PARSER.y"
    {runSetAlias((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string)); disableAliases = false; return 1;;}
    break;

...
static const yytype_uint8 yyrline[] =
{
      ...
      66,    70,    75,    79,    86,    93,   101,   104,   105,   117,
     118,   121,   122
};
#endif
  ...
  switch (yyn)
    {
        case 2:
#line 34 "PARSER.y"
    {if(!reparsing){exit(1);} return 1; ;}
    break;

  case 3:
#line 35 "PARSER.y"
    {if(!reparsing){setEnv((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string));}  return 1;;}
    break;

  case 4:
#line 36 "PARSER.y"
    {if(!reparsing){printEnv();}  return 1;;}
    break;

  case 5:
#line 37 "PARSER.y"
    {if(!reparsing){printEnvFile((yyvsp[(3) - (4)].string), 0);} return 1;;}
    break;

  case 6:
#line 38 "PARSER.y"
    {if(!reparsing){printEnvFile((yyvsp[(4) - (5)].string), 1);} return 1;;}
    break;

  case 7:
#line 39 "PARSER.y"
    {if(!reparsing){unsetEnv((yyvsp[(2) - (3)].string));}  return 1;;}
    break;

  case 8:
#line 40 "PARSER.y"
    {if(!reparsing){unsetAlias((yyvsp[(2) - (3)].string));}  return 1;;}
    break;

  case 9:
#line 41 "PARSER.y"
    {if(!reparsing){runCD((yyvsp[(2) - (3)].string));}  return 1;;}
    break;

  case 10:
#line 42 "PARSER.y"
    { if(!reparsing){runCDHome();}  return 1;;}
    break;

  case 11:
#line 43 "PARSER.y"
    {if(!reparsing){runSetAlias((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string));}  return 1;;}
    break;

  case 12:
#line 44 "PARSER.y"
    { if(!reparsing){listAlias();} return 1;;}
    break;

  case 13:
#line 45 "PARSER.y"
    {if(!reparsing){printAliasFile((yyvsp[(3) - (4)].string),0);} return 1;;}
    break;

  case 14:
#line 46 "PARSER.y"
    {if(!reparsing){printAliasFile((yyvsp[(4) - (5)].string),1);} return 1;;}
    break;
